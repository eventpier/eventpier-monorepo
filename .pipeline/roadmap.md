...
| 006 | Health-check com cache em memória por capability (TTL configurável via `HEALTH_CHECK_TTL_MS`, default 3-5s, com invalidação ativa em falha de chamada real) | 🟡 Em andamento | 2026-08-20 |
