...
| 003 | Docker Compose do MVP (rede interna `eventpier-net`, `ministack` opcional via profile, apenas `eventpier-ui` exposta ao host entre os serviços do Eventpier) | 🟡 Em andamento | 2026-08-12 |
