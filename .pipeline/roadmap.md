...
| 008 | Capability Storage (listar buckets, abrir bucket, listar objetos, navegar por prefixos) via MiniStack Adapter, usando AWS SDK apontando o `endpoint` do MiniStack | ✅ Concluído | 2026-08-25 |
